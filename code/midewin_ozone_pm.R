...
o3_pm_dat <- read_csv("data/midewin_ntgp_air_monitors_annual.csv") %>% 
...
ggsave("figures/midewin_ntgp_ozone_3_year_mean.jpg",
       height = 3,
       width = 4.2,
       unit = "in")
...
ggsave("figures/midewin_ntgp_pm_3_year_mean.jpg",
       height = 3,
       width = 4.2,
       unit = "in")
...
ggsave("figures/midewin_ntgp_pm_3_year_98th.jpg",
       height = 3,
       width = 4.2,
       unit = "in")
...
# midewin_sf <- sf::st_as_sf(midewin)
...
ggplot() +
  geom_polygon(aes(long, lat, group = group, alpha = "200km buffer"),
               ...
               fill = NA,
               data = unit_buffer_df) +
  geom_polygon(aes(long, lat, group = group, alpha = "Midewin NTGP"),
               color = "darkgreen",
               size = 1,
               fill = "darkgreen",
               data = unit_df) +
...
ggsave("figures/midewin_ntgp_oz_pm_monitors.jpg",
       height = 3.2,
       width = 4,
       units = "in")

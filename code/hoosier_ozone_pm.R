...
write_csv(buffer_mons_df, "data/hoosier_nf_air_monitors_annual.csv")
...
o3_pm_dat <- read_csv("data/hoosier_nf_air_monitors_annual.csv") %>% 
...
ggsave("figures/hoosier_nf_ozone_3_year_mean.jpg",
       height = 3,
       width = 4.2,
       unit = "in")
...
ggsave("figures/hoosier_nf_pm_3_year_mean.jpg",
       height = 3,
       width = 4.2,
       unit = "in")
...
ggsave("figures/hoosier_nf_pm_3_year_98th.jpg",
       height = 3,
       width = 4.2,
       unit = "in")
...
ggplot() +
  geom_polygon(aes(long, lat, group = group, alpha = "200km buffer"),
               ...
               fill = NA,
               data = unit_buffer_df) +
  geom_polygon(aes(long, lat, group = group, alpha = "Hoosier NF"),
               color = "darkgreen",
               size = 1,
               fill = "darkgreen",
               data = unit_df) +
...
ggsave("figures/hoosier_nf_oz_pm_monitors.jpg",
       height = 3.2,
       width = 4,
       units = "in")
